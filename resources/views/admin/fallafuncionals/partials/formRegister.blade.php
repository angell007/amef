<div class="modal fade --" tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal id="modalFallaFuncionalRegister">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">

            <div class="card-header text-dark">Registrar FallaFuncional
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form id="formFallaFuncionalRegister" method="POST" action="{{ route('falla-funcionals.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-outline-info " id="btnSaveFallaFuncional" value="Enviar">
