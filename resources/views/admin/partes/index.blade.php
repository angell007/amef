        ...
        <div class="card card-statistics">
            <div class="card-body">
                <div class="export-table-wrapper table-responsive">
                    <table class="table table-bordered " style="color:black" id="dataTableParte" width="100%" cellspacing="0">
                        <thead class="thead">
                            <tr>
                                <th>S. No</th>
                                <th>Nombre</th>
...
@include('admin.partes.partials.formUpdate') 
@include('admin.partes.partials.formRegister')

@stop

@section('scripts')
<script src="{{ asset('/js/apiParte.js') }}"></script>
<script defer src="{{ asset('/js/partesListener.js') }}"></script>
@endsection
