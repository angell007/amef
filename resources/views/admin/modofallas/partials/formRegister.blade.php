<div class="modal fade --" tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal id="modalModoFallaRegister">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">

            <div class="card-header text-dark">Registrar Modo de Falla
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form id="formModoFallaRegister" method="POST" action="{{ route('modo-fallas.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-outline-info " id="btnSaveModoFalla" value="Enviar">
